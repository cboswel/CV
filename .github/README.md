...
### Electronics and Computing Degree Apprentice in Advanced Control Unit (2020 - present)

**JET CODAS / ACU projects**

 * Worked with VxWorks real-time operating system while diagnosing a fault in KG1-RT interferometer data acquisition
 * Learned modern dev-ops practices while contributing to development of RTCC2 GUI
 * Produced onboarding materials for MARTe2 learners and created forum for external and internal users
 * Produced documentation e.g. MAST-U PCS upgrade documentation
...
**Innovation Projects**
 ...
 Assisted with several innovation projects. I designed and conducted experiments, collected data and kept documentation. Projects include Pi Core Autonomy, Soft sensors for robotics, Digital nuclear track detectors and Nimbus fast neutron diagnostic.
 ...
 * Communications engineering optional module. Studied analogue and digital
   communications including information theory, modulation techniques, 
...
### Apprenticeship (2020 - 2025)
  ...
  required proof that I work to the standard of an incorporated engineer.

### BSc Music Technology, Staffordshire University (2012 - 2015)

  Sparked an interest in electronics through modules about microphone and speaker
  design. When later studying electronics I discovered that signal processing 
  techniques I was learning are applied in audio too. 
